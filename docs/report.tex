...
\begin{figure}[!ht]
	\centering
	\begin{tikzpicture}
		\begin{axis}[width=0.6\textwidth,height=0.3775\textwidth,xmax=1,ymax=1,ymin=0.8,xmin=0.8]
			\includegraphics[width=0.51\textwidth]{docs/report/mfield/frame.jpg}
			\addplot[red,thick,quiver={u=\thisrow{u},v=\thisrow{v}},-stealth] table[col sep=comma] {docs/report/mfield/base.csv};
			\addplot[green,thick,quiver={u=\thisrow{u},v=\thisrow{v}},-stealth] table[col sep=comma] {docs/report/mfield/0.csv};
			\addplot[green,thick,quiver={u=\thisrow{u},v=\thisrow{v}},-stealth] table[col sep=comma] {docs/report/mfield/1.csv};
			\addplot[green,thick,quiver={u=\thisrow{u},v=\thisrow{v}},-stealth] table[col sep=comma] {docs/report/mfield/2.csv};
			\addplot[green,thick,quiver={u=\thisrow{u},v=\thisrow{v}},-stealth] table[col sep=comma] {docs/report/mfield/3.csv};
