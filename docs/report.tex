...
\begin{figure}[!ht]
	...
	\end{tikzpicture}
	\caption{\centering Render loop with OFPS Suite's substate. wimrend has no knowlege of the substate, but is able to provide facilities to drive custom logic and rendering.}
\end{figure}
...
OFPS core library has been fully documented, each plugin has a description, and this documentation can be viewed using \texttt{cargo doc --open} command. In addition, several miscelaneous utilities are available in the repository for optical flow extraction.
